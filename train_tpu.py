...
# --- Sharded Memory-Mapped Dataset (Fixed) ---
class ShardDataset(Dataset):
    def __init__(self, data_dir: str, sequence_length: int):
        ...
        # CRITICAL FIX: Changed self.mmap_shards to self.shards in the list comprehension
...
def _mp_fn(index, config: TrainConfig):
    ...
    while current_step < config.max_steps:
        ...
        # CRITICAL FIX: Add memory management to prevent accumulation during long runs
